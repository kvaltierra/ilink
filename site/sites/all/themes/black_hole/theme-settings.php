...
// Layout Settings
  ...
  $form['tnt_container']['layout_settings']['blockicons'] = array(
    ...
    '#options' => array(
      0 => 'No',
      1 => 'Yes (32x32 pixels, positive images)',
      2 => 'Yes (48x48 pixels, positive images)',
      3 => 'Yes (32x32 pixels, negative images)',
      4 => 'Yes (48x48 pixels, negative images)',
    )
  );
  ...
  $form['tnt_container']['layout_settings']['navpos'] = array(
    ...
    '#description' => t('"Out of the box" Black Hole will display a static menu. To activate the drop-down menu put the <a href="?q=/admin/structure/block/manage/system/main-menu/configure">Main menu block</a> in the "Drop Down menu" region and set the correct levels to "expanded" (the parent item). <br /> NOTE: Only the static menu can be properly centered. <br /> NOTE for RTL sites: IE6 will accept only left positioned Drop-Down menu.'),
    '#options' => array(
      0 => 'Left',
      1 => 'Center',
      2 => 'Right',
  ...
  $form['tnt_container']['layout_settings']['roundcorners'] = array(
    ...
    '#description' => t('Some page elements (comments, search, blocks) and primary menu will have rounded corners in all browsers but IE6,7. <br /> NOTE: With this option enabled Black Hole will not validate CSS2/CSS3.'),
