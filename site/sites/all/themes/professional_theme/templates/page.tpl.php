  ...
  <div id="container">
    ...
    <?php if ($is_front): ?>
      <?php if (theme_get_setting('slideshow_display', 'professional_theme')): ?>
        <!-- Slides -->
  <?php
  $slide1_head = check_plain(theme_get_setting('slide1_head','professional_theme'));   $slide1_desc = check_markup(theme_get_setting('slide1_desc','professional_theme')); $slide1_url = check_plain(theme_get_setting('slide1_url','professional_theme')); $slide1_img= check_markup(theme_get_setting('slide1_image_url','professional_theme')); $slide_alt = check_plain(theme_get_setting('slide_alt','professional_theme'));
  $slide2_head = check_plain(theme_get_setting('slide2_head','professional_theme'));   $slide2_desc = check_markup(theme_get_setting('slide2_desc','professional_theme')); $slide2_url = check_plain(theme_get_setting('slide2_url','professional_theme')); $slide2_img= check_markup(theme_get_setting('slide2_image_url','professional_theme')); $slide2_alt= check_plain(theme_get_setting('slide2_alt','professional_theme'));
  $slide3_head = check_plain(theme_get_setting('slide3_head','professional_theme'));   $slide3_desc = check_markup(theme_get_setting('slide3_desc','professional_theme')); $slide3_url = check_plain(theme_get_setting('slide3_url','professional_theme')); $slide3_img= check_markup(theme_get_setting('slide3_image_url','professional_theme')); $slide3_alt= check_plain(theme_get_setting('slide3_alt','professional_theme'));
