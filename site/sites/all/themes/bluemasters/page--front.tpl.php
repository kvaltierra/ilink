    ...
    <div id="wrapper">
        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <div class="slider-item-caption">A Tale of Two Tracks</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <div class="slider-item-caption">Hot, Dry, and Dead</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <div class="slider-item-caption">High and Dry Near a Grand</div>
                </li>
                <!-- EOF: slider-item -->
